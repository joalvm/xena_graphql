...
export class Employees extends BaseEntity {
  ...
  @Column('boolean', { name: 'eps_affiliation', nullable: true })
  epsAffiliation!: boolean | null
  ...
  @Column('boolean', { name: 'unionized', nullable: true })
  unionized!: boolean | null

  @Column('boolean', { name: 'sctr_affiliation', nullable: true })
  sctrAffiliation!: boolean | null

  @Column('boolean', { name: 'ev_affiliation', nullable: true })
  evAffiliation!: boolean | null
